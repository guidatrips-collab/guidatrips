  ...
  return (
    <div className="flex flex-col min-h-screen text-[#0D1B2A] bg-[#FBF9F6] font-sans selection:bg-[#E8711A]/20">
      ...
      <ClientDashboardDrawer 
        isOpen={isCartOpen || currentView === "roteiro"}
        onClose={() => {
          setIsCartOpen(false);
          if (currentView === "roteiro") handleNavigate("home");
        }}
        cart={cart}
        experiences={experiences}
        accommodations={accommodations}
        ...
        onRemoveFromCart={handleRemoveFromCart}
        selectedHotelId={selectedHotelId}
        arrivalDate={cart[0]?.date || ""}
        adults={2}
        children={0}
        destName={destinations.find(d => d.id === selectedDestinationId)?.name || "Arraial do Cabo"}
