        ...
        <div className="flex flex-wrap justify-center gap-2 mt-10">
          {[
            ...
            <button
              ...
              className={`px-5 py-2.5 rounded-sm font-accent text-xs font-bold tracking-widest uppercase transition-all duration-300 ${
            ...
            >
              ...
              <div className="p-6 sm:p-8 flex-grow space-y-4 text-left">
                <div className="space-y-1">
                  ...
                  <h3 className="font-serif text-xl font-bold text-[#0D1B2A] hover:text-[#E8711A] transition-colors leading-snug">
                    {pousada.name}
                  </h3>
                </div>
                ...
                <div className="bg-[#FBF9F7] p-3 border-l-2 border-[#E8711A] rounded-r text-xs font-sans text-[#0D1B2A] font-semibold italic">
              ...
              <div className="p-6 sm:p-8 border-t border-zinc-100 bg-zinc-50/50 flex flex-col sm:flex-row items-center justify-between gap-4">
                <div className="text-center sm:text-left">
                  <span className="font-accent text-[9px] text-zinc-400 tracking-wider uppercase block">MELHOR TARIFA</span>
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-5 py-3 bg-[#0D1B2A] hover:bg-[#E8711A] text-white hover:text-[#0D1B2A] font-accent text-xs font-bold tracking-widest uppercase transition-colors rounded shadow-sm hover:scale-[1.02] flex items-center justify-center gap-1"
                >
